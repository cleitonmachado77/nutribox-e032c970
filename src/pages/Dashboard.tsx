          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              {monthlyData.length > 0 ? <BarChart data={monthlyData}>
                  ...
                  <XAxis dataKey="month" />
                  <YAxis domain={[0, (dataMax) => (dataMax == null || dataMax === undefined) ? 1 : Math.max(dataMax, 1)]} />
                  <Tooltip />
          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              ...
              bottom: 5
                  ...
                  <CartesianGrid strokeDasharray="3 3" stroke="#E5E5E5" />
                  <XAxis type="number" domain={[0, (dataMax) => (dataMax == null || dataMax === undefined) ? 1 : Math.max(dataMax, 1)]} />
