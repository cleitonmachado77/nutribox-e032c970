...
const Kanban = () => {
  ...
  const [columns, setColumns] = useState<Column[]>([{
    ...
    leads: [{
      id: 1,
      nome: "Ricardo Borges",
      objetivo: "Aproveitadora por idade",
      telefone: "(11) 99705-4321"
    }, {
      id: 2,
      nome: "Juliana Ramos",
      objetivo: "Isenção ID",
      telefone: "(21) 98134-5566"
    }, {
      id: 3,
      nome: "Paulo Henrique",
      objetivo: "Aproveitadora por idade",
    ...
    leads: [{
      id: 4,
      nome: "João Souza",
      objetivo: "Auxílio acidente",
      telefone: "(19) 98765-4321"
    }, {
      id: 5,
      nome: "Ana Paula",
      objetivo: "Auxílio-doença",
      telefone: "(11) 96765-4321"
    }]
  }, {
    id: "qualificado",
    title: "Qualificado",
    ...
    leads: [{
      id: 6,
      nome: "Carlos Lima",
      objetivo: "Aguardando Resposta",
      telefone: "(21) 98765-4321"
    }, {
      id: 7,
      nome: "Beatriz Gomes",
      objetivo: "Pensão por morte",
      telefone: "(31) 98765-4321"
    }, {
      id: 8,
      nome: "Ricardo Silva",
      objetivo: "Aposentadoria especial",
      telefone: "(41) 98765-4321"
    }, {
      id: 9,
      nome: "Mariana Costa",
      objetivo: "Revisão de benefício",
    ...
    leads: [{
      id: 10,
      nome: "Fernando Alves",
      objetivo: "Planejamento Previdenciário",
  ...
  return <div className="p-6 space-y-6 bg-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {columns.map(column => <Card key={column.id} className={`h-fit transition-all duration-200 ${dragOverColumn === column.id ? `border-2 ${column.borderColor} bg-gray-50` : 'border border-gray-200'}`} onDragOver={e => handleDragOver(e, column.id)} onDragLeave={handleDragLeave} onDrop={e => handleDrop(e, column.id)}>
            ...
            <CardContent className="space-y-3">
              {column.leads.map(lead => <Card key={lead.id} className={`p-3 transition-all duration-200 cursor-move select-none ${draggedLeadId === lead.id ? 'opacity-50 border-2 border-purple-500 shadow-lg' : 'hover:shadow-md border border-gray-200'}`} draggable onDragStart={e => handleDragStart(e, lead.id)} onDragEnd={handleDragEnd}>
              ...
              {/* Add new lead button */}
              <Button variant="outline" className="w-full h-20 border-dashed border-2 border-purple-300 hover:border-purple-500 hover:bg-purple-50">
