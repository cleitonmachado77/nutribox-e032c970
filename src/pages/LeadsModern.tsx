  ...
  if (isLoading) {
    return (
      <div className="p-8 bg-white min-h-screen">
        <Header title="Leads" description="Track and manage all new contacts from potential patients" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg border-0 rounded-xl hover:shadow-xl transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-purple-100">Total de Leads</CardTitle>
              <Users className="h-5 w-5 text-purple-200" />
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-white">{leads.length}</div>
              <p className="text-sm text-purple-100 mt-1">
                {leads.length === 0 ? "Nenhum lead cadastrado" : "Leads na plataforma"}
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-lg border-0 rounded-xl hover:shadow-xl transition-all duration-300">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-green-100">Leads Filtrados</CardTitle>
            ...
            <Sheet open={filterModalOpen} onOpenChange={setFilterModalOpen}>
              ...
              <SheetContent side="right" className="w-[400px] sm:w-[540px]">
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Refine sua busca para encontrar leads específicos
                  </SheetDescription>
                </SheetHeader>
                            ...
                            <TableCell>
                              <div className="flex items-center space-x-3">
                                <Avatar className="h-10 w-10 ring-2 ring-purple-100">
                                  {lead.foto_perfil && (
                                    <AvatarImage src={lead.foto_perfil} alt={lead.nome || 'Lead'} className="object-cover" />
                                  )}
